...
export const brandRateReducer = (state = [], action) => {
    switch (action.type) {
        case BRAND_RATE_REQUEST:
            return {loading: true }

        case BRAND_RATE_SUCCESS:
            return { loading: false, rate: action.payload.rate }

        case BRAND_RATE_FAIL:
            return { loading: false, error: action.payload }
